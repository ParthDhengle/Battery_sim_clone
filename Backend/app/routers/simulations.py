# Backend/app/routers/simulations.py (FINAL VERSION)
...
sys.path.append(r"C:\Users\Parth Dhengle\Desktop\Projects\YCS TECH\battery-simulation-ycs\Backend\Core-python code")
import NEW_data_processor as adp
import NEW_electrical_solver as aes

router = APIRouter(prefix="/simulations", tags=["simulations"])
os.makedirs("simulations", exist_ok=True)

STATIC_CSV_PATH = r"C:\Users\Parth Dhengle\Desktop\Projects\YCS TECH\battery-simulation-ycs\Backend\Core-python code\simulation_results.csv"
