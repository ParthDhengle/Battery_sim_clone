# Backend/Core-python code/NEW_electrical_solver.py
# (Copied from electrical_solver.py - only change: add filename param to run_electrical_solver and pass to save_to_csv)
import numpy as np
import time
import pandas as pd
...
def run_electrical_solver(setup, filename="simulation_results.csv"):
    ...
    print(f"DEBUG: Upper Limit = {cell_voltage_upper_limit}, Lower Limit = {cell_voltage_lower_limit}")
